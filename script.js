...
[체크리스트 생성 과정]
1단계: 업로드된 사진을 분석하여 어떤 공종인지 추정
2단계: 참고 법령 및 지침에서 관련 기준 확인
3단계: 해당 공종에 맞는 현장 점검 체크리스트 생성

[작성 규칙]
1. 체크리스트 개수: 최소 10개, 최대 15개 (반드시 준수)

2. 구성 비율:
   - 공종 기반 디테일 점검 항목: 50% 이상 (초보 공사감독이 놓치기 쉬운 항목 위주)
   - 기본 안전 점검 항목: 30~50%
...
4. 기본 안전 항목은 세부적으로 나누지 말고 통합 작성:
   예) "작업자 안전모 및 보호구 착용 여부" (안전모, 안전화, 조끼를 각각 나누지 않음)

5. 법령에 근거가 있으면 조항 표기, 없더라도 현장에서 중요한 항목은 반드시 포함

6. 설명문 없이 체크리스트 항목만 작성
