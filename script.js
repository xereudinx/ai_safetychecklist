...
예) 굴착공사를 선택했는데 사진에 콘크리트 구조물이 보여도 콘크리트 관련 항목은 생성하지 않음
예) 철근 작업을 선택했는데 사진에 비계가 보여도 비계 관련 항목은 생성하지 않음
...
2. 구성 순서와 비율:
   ...
   ② 선택 공종 기반 전문 항목 (추가 항목의 50~60%)
     - 사용자가 선택한 공종의 핵심 점검사항
     - 초보 공사감독이 놓치기 쉬운 전문 항목 위주
   ③ 사진 분석 기반 보조 항목 (추가 항목의 40~50%)
     - 사진에서 관찰된 현장 상황 중 선택 공종과 직접 관련된 위험요소만 추가
     - 선택한 공종과 관련 없는 주변 구조물, 시설에 대한 항목은 절대 포함하지 않음

3. groups 배치 순서:
   - 첫 번째 group: "[기본] 안전점검 필수 항목" (위 3개 항목 고정)
   - 두 번째 group: "[공종] 선택 공종명" (공종 전문 항목)
   - 세 번째 group: "[현장] 사진 분석 보조 항목" (선택 공종과 관련된 사진 기반 항목만)
